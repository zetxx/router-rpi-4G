...
while true; do
  if curl -m 2 http://10.21.21.1/index.html | grep --quiet "{" ; then
    echo "online"
    sleep 10
    ## PIN
    #curl -X POST \
    ...
    #-H "Origin: http://10.21.21.1" \
    #-H "Referer: http://10.21.21.1/index.html" \
    #http://10.21.21.1/goform/goform_set_cmd_process
    #sleep 1
    ## MODE
    curl -X POST \
